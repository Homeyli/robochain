            ...
            <div class="col-lg-7 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                <div class="ms-lg-5">
                    <div class="section-title mb-3">
                        <span class="badge rounded-pill bg-soft-primary">sadasd</span>
                    ...
                    <ul class="list-unstyled text-muted">
                        <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>Fully Responsive</li>
