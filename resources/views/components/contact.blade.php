        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="section-title mb-4 pb-2">
                    <h4 class="title mb-4" data-aos="fade-up" data-aos-duration="1000">سفارش ایجاد ربات !</h4>
                    <p class="text-muted para-desc mx-auto mb-0" data-aos="fade-up" data-aos-duration="1400">از طریق فورم زیر شماره موبایل خود را وارد کنید تا با شما در ارتباط باشیم</p>
                </div>
            </div><!--end col-->
        </div><!--end row-->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 col-md-6 mt-4 pt-2 order-1 order-md-2">
                <div class="title-heading ms-lg-4">
                    ...
                    <p class="text-muted" data-aos="fade-up" data-aos-duration="1400">از طریق فورم رو به رو و همچنین راه های ارتباطی پایین با ما در ارتباط باشید</p>
                        ...
                        <div class="card-body p-0">
                            <div class="contact-detail d-flex align-items-center mt-3" data-aos="fade-up" data-aos-duration="1200">
                                ...
                                <div class="content overflow-hidden d-block">
                                    <h6 class="fw-bold mb-0">ایمیل</h6>
                                    <a href="mailto:contact@example.com" class="text-primary">stackteam.official@gmail.com</a>
                                </div>  
                            </div>
                        </div>
                    </div>
